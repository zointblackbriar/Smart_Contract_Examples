...
const getEnv = env => {
  ...
  if(typeof value === 'undefined') {
    //throw new error('${env} has not been defined');
    console.log("we should define an error");
  }
...
const mnemonicRapsten = "test mnemonic";
  ...
  networks: {
    ...
    rapsten: {
      provider: ()=> 
        ...
        network_id: 3 //official id of the rapsten network
    }

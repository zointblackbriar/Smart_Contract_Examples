...
The nightly version is updated very frequently, so you might want to update it every week or more often. 
...
You should add wasm32 toolchain with the following command
```console
...
## Test nighthly build with the following commands

...
contract BoxingBets {
    ...
    function _betIsValid(address _user, bytes32 _matchId, uint8 _chosenWinner) private pure returns (bool) {
    ...
    function _matchOpenForBetting(bytes32 _matchId) private pure returns (bool) {

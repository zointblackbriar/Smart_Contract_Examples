...
public class IGovernorTimelock extends Contract {
    ...
    public static RemoteCall<IGovernorTimelock> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorTimelock.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorTimelock> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorTimelock.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorTimelock> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(IGovernorTimelock.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<IGovernorTimelock> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(IGovernorTimelock.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

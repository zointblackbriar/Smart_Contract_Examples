...
public class ERC20Wrapper extends Contract {
    ...
    public static RemoteCall<ERC20Wrapper> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ERC20Wrapper.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<ERC20Wrapper> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ERC20Wrapper.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

...
public class IBridge extends Contract {
    ...
    public List<BridgeCallTriggeredEventResponse> getBridgeCallTriggeredEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(BRIDGECALLTRIGGERED_EVENT, transactionReceipt);
    ...
    public List<InboxToggleEventResponse> getInboxToggleEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(INBOXTOGGLE_EVENT, transactionReceipt);
    ...
    public List<MessageDeliveredEventResponse> getMessageDeliveredEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(MESSAGEDELIVERED_EVENT, transactionReceipt);
    ...
    public List<OutboxToggleEventResponse> getOutboxToggleEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(OUTBOXTOGGLE_EVENT, transactionReceipt);
    ...
    public List<SequencerInboxUpdatedEventResponse> getSequencerInboxUpdatedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(SEQUENCERINBOXUPDATED_EVENT, transactionReceipt);
    ...
    public Flowable<SequencerInboxUpdatedEventResponse> sequencerInboxUpdatedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, SequencerInboxUpdatedEventResponse>() {
            @Override
            public SequencerInboxUpdatedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(SEQUENCERINBOXUPDATED_EVENT, log);
                SequencerInboxUpdatedEventResponse typedResponse = new SequencerInboxUpdatedEventResponse();
                typedResponse.log = log;
                typedResponse.newSequencerInbox = (String) eventValues.getNonIndexedValues().get(0).getValue();
                return typedResponse;
    ...
    public RemoteFunctionCall<Boolean> allowedDelayedInboxes(String inbox) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_ALLOWEDDELAYEDINBOXES, 
    ...
    public RemoteFunctionCall<byte[]> delayedInboxAccs(BigInteger param0) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_DELAYEDINBOXACCS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(param0)), 
    ...
    public RemoteFunctionCall<BigInteger> delayedMessageCount() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_DELAYEDMESSAGECOUNT, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public RemoteFunctionCall<TransactionReceipt> enqueueDelayedMessage(BigInteger kind, String sender, byte[] messageDataHash) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<byte[]> sequencerInboxAccs(BigInteger param0) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SEQUENCERINBOXACCS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(param0)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
        return executeRemoteCallSingleValueReturn(function, byte[].class);
    }
    ...
    public RemoteFunctionCall<BigInteger> sequencerMessageCount() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SEQUENCERMESSAGECOUNT, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> sequencerReportedSubMessageCount() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SEQUENCERREPORTEDSUBMESSAGECOUNT, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

...
public class ClonesMock extends Contract {
    ...
    public List<NewInstanceEventResponse> getNewInstanceEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(NEWINSTANCE_EVENT, transactionReceipt);
    ...
    public RemoteFunctionCall<TransactionReceipt> clone(String implementation, byte[] initdata) {
    ...
    public RemoteFunctionCall<TransactionReceipt> cloneDeterministic(String implementation, byte[] salt, byte[] initdata) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(

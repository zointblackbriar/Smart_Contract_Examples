...
public class ICompoundTimelock extends Contract {
    ...
    public List<CancelTransactionEventResponse> getCancelTransactionEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(CANCELTRANSACTION_EVENT, transactionReceipt);
    ...
    public List<QueueTransactionEventResponse> getQueueTransactionEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(QUEUETRANSACTION_EVENT, transactionReceipt);
    ...
    public RemoteFunctionCall<TransactionReceipt> executeTransaction(String target, BigInteger value, String signature, byte[] data, BigInteger eta) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(

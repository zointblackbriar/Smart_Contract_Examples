...
public class IArbSys extends Contract {
    ...
    public List<L2ToL1TransactionEventResponse> getL2ToL1TransactionEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(L2TOL1TRANSACTION_EVENT, transactionReceipt);
    ...
    public List<L2ToL1TxEventResponse> getL2ToL1TxEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(L2TOL1TX_EVENT, transactionReceipt);
    ...
    public List<SendMerkleUpdateEventResponse> getSendMerkleUpdateEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(SENDMERKLEUPDATE_EVENT, transactionReceipt);
    ...
    public RemoteFunctionCall<TransactionReceipt> sendTxToL1(String destination, byte[] data) {
    ...
    public RemoteFunctionCall<TransactionReceipt> withdrawEth(String destination) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_WITHDRAWETH, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, destination)), 
                Collections.<TypeReference<?>>emptyList());

...
public class IAMB extends Contract {
    ...
    public List<UserRequestForAffirmationEventResponse> getUserRequestForAffirmationEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(USERREQUESTFORAFFIRMATION_EVENT, transactionReceipt);

...
public class DummyImplementationV2 extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> initializePayable() {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> initializePayableWithValue(BigInteger _value) {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> migrate(BigInteger newVal) {
        final Function function = new Function(
                FUNC_MIGRATE, 

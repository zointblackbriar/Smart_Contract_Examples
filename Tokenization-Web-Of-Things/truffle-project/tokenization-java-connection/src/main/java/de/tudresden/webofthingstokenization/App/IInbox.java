...
public class IInbox extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> createRetryableTicket(String to, BigInteger l2CallValue, BigInteger maxSubmissionCost, String excessFeeRefundAddress, String callValueRefundAddress, BigInteger gasLimit, BigInteger maxFeePerGas, byte[] data) {
    ...
    public RemoteFunctionCall<TransactionReceipt> sendL1FundedContractTransaction(BigInteger gasLimit, BigInteger maxFeePerGas, String to, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> sendL1FundedUnsignedTransaction(BigInteger gasLimit, BigInteger maxFeePerGas, BigInteger nonce, String to, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> unsafeCreateRetryableTicket(String to, BigInteger l2CallValue, BigInteger maxSubmissionCost, String excessFeeRefundAddress, String callValueRefundAddress, BigInteger gasLimit, BigInteger maxFeePerGas, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(

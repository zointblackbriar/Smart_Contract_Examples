...
public class ERC3156FlashBorrowerMock extends Contract {
    ...
    public List<BalanceOfEventResponse> getBalanceOfEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(BALANCEOF_EVENT, transactionReceipt);
    ...
    public List<TotalSupplyEventResponse> getTotalSupplyEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TOTALSUPPLY_EVENT, transactionReceipt);

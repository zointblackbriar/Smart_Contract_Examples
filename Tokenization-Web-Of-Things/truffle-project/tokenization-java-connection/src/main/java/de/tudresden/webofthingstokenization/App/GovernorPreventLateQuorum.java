...
public class GovernorPreventLateQuorum extends Contract {
    ...
    public List<LateQuorumVoteExtensionSetEventResponse> getLateQuorumVoteExtensionSetEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(LATEQUORUMVOTEEXTENSIONSET_EVENT, transactionReceipt);
    ...
    public List<ProposalExtendedEventResponse> getProposalExtendedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PROPOSALEXTENDED_EVENT, transactionReceipt);
    ...
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GovernorPreventLateQuorum> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(GovernorPreventLateQuorum.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

...
public class VestingWallet extends Contract {
    ...
    public List<ERC20ReleasedEventResponse> getERC20ReleasedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(ERC20RELEASED_EVENT, transactionReceipt);
    ...
    public List<EtherReleasedEventResponse> getEtherReleasedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(ETHERRELEASED_EVENT, transactionReceipt);

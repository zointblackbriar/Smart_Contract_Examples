...
public class RetailerAspect {
	...
	@Before("execution(* de.tudresden.retailer.Retailer.addRetailer(..))")
	...
	@After("execution(* de.tudresden.retailer.Retailer.addRetailer(..))")
	...
	@Around("execution(* de.tudresden.retailer.Retailer.addRetailerAround(..))")

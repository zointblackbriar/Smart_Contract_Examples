...
public class BasicInfoGetter extends Contract {
    public static final String BINARY = "";

    public static final String FUNC_KILL = "kill";

    public static final String FUNC_GETCONTRACTADDRESSSELF = "getContractAddressSelf";
    ...
    public RemoteFunctionCall<String> getContractAddressSelf() {
        final Function function = new Function(FUNC_GETCONTRACTADDRESSSELF, 
                Arrays.<Type>asList(), 
    ...
    public RemoteFunctionCall<BigInteger> getTxGasprice() {
    ...
    public RemoteFunctionCall<BigInteger> getBlockTimestamp() {
    ...
    public RemoteFunctionCall<String> getMsgSender() {
    ...
    public RemoteFunctionCall<BigInteger> getCurrentGaslimit() {
    ...
    public RemoteFunctionCall<BigInteger> getMsgGas() {
    ...
    public RemoteFunctionCall<BigInteger> getCurrentDifficulty() {
    ...
    public RemoteFunctionCall<TransactionReceipt> getMsgValue(BigInteger weiValue) {
        final Function function = new Function(
                FUNC_GETMSGVALUE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<String> getTxOrigin() {
    ...
    public RemoteFunctionCall<byte[]> getMsgData() {
    ...
    public RemoteFunctionCall<String> getCurrentMinerAddress() {
